<html>
  <head custom-load-custom-css="custom-load-custom-css">
    ...
    <title custom-title="title">settings - timeout</title>
            ...
            <div class="container-fluid" id="settings-content">
              ...
              <form class="form-horizontal">
                <div class="explanation">
                  Here you can determine how long you may remain inactive before being automatically logged off.
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-3" for="autoLogout">
                    Inactivity timeout
                  </label>
                  <div class="col-sm-4">
                    <select class="form-control" name="autoLogout">
