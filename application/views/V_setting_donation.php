<html>
  <head custom-load-custom-css="custom-load-custom-css">
    ...
    <title custom-title="title">settings - donation</title>
...
<!-- ubah disini -->
              <div class="container-fluid ng-binding" id="settings-content">
                <h1>Donations</h1>
                <form class="form-horizontal ng-pristine ng-valid" ng-submit="submit()">
                  <div class="explanation">
                    monkkee is free of charge and should remain free – You can make a contribution to help keep monkkee alive and running! Become part of a growing community of monkkee supporters – Help the monkkee team with your donation! Click here to go to the <a href="#" target="_blank">donation page</a>.
                  </div>
                  <div class="explanation">
                    If you have already made a donation and the email address of your PayPal transaction differs from the one you are using in your monkkee account, you can activate your donation here. Simply enter the activation code you received by email. This will turn off all donation reminders for you.
                  </div>
                  <div class="form-group ">
                    <label class="control-label col-sm-3" for="activation-key">
                      Activation code
                    </label>
                    <div class="col-sm-4">
                      <input class="form-control" id="activation-key" type="text">
                ...
                <br>
                <h2>Your last donation to monkkee</h2>
