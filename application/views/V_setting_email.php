<html>
  <head custom-load-custom-css="custom-load-custom-css">
    ...
    <title custom-title="title">settings - email</title>
              ...
              <div class="container-fluid" id="settings-content">
                ...
                <form class="form-horizontal">
                  <div class="explanation">
                    Here you can change the email address that is associated with your monkkee account. After submitting the form, an email with a confirmation link will be sent to this address. When clicking on this link, your address will be changed.
                  </div>
