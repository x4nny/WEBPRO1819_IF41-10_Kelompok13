<html>
  <head custom-load-custom-css="custom-load-custom-css">
    ...
    <title custom-title="title">settings - alias</title>
              ...
              <div class="container-fluid" id="settings-content">
                ...
                <form class="form-horizontal">
                  <div class="explanation">
                    Here you can assign a login alias which you can use to sign in with instead of your email address. Logging in with your email address will still be possible.
                  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-3" for="use-alias">
                      Use alias?
                    </label>
                    <div class="col-sm-4">
                      <div class="checkbox">
                        <label>
                          <input id="use-alias" type="checkbox" value="use-alias">
                        </label>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-3" for="alias">
                      Alias
                    </label>
                    <div class="col-sm-4">
                      <input class="form-control" id="alias" type="text" value="alias" disabled="disabled">
                    </div>
                  </div>
                  <div class="form-group">
